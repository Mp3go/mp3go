            ...
            <div className="flex-1 flex flex-col justify-end">
              <div className="flex flex-col md:flex-row md:mt-5 justify-between justify-self-end">
                <button
                  ...
                  className="flex-1 flex justify-center items-center rounded-lg text-white md:text-[1rem] lg:text-[1rem]  text-[.8rem] border-0 outline-0 w-full p-[.8rem] md:p-[1rem] m-1 transition ease-in-out delay-150 hover:scale-y-110 duration-300 bg-black">
                ...
                <button
                  ...
                  className="flex-1 flex justify-center items-center rounded-lg text-white md:text-[0.9rem] lg:text-[1rem] text-[.8rem] border-0 outline-0 w-full p-[0.8rem] md:p-[1rem] m-1 transition ease-in-out delay-150 hover:scale-y-110 duration-300 bg-black">
