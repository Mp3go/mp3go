      ...
      <a href={`/music/${id}`}>
        ...
        <div className='px-6 lg:py-4 h-32 mt-2'>
          ...
          <div className='flex justify-between'>
            {!isWishlistPage && (<button className='bg-none text-white md:text-[1rem] lg:text-[1.2rem]  text-[.8rem] border-0 outline-0 w-full py-[0.4rem] md:py-[0.8rem] m-1 transition ease-in-out delay-150 hover:scale-y-110 duration-300 bg-black'>
              Wishlist
            </button>)}
